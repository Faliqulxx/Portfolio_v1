...
export default function AIAssistantPage() {
  ...
  return (
    <div className="fixed inset-0 top-[4.5rem] sm:top-[5.5rem] pb-4 px-4 sm:px-6 lg:px-8 flex flex-col items-center overflow-hidden z-[100] bg-gray-50 dark:bg-gray-950">
