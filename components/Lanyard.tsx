...
export default function Lanyard({
  ...
  return (
    <div className="relative z-0 w-full h-full min-h-[350px] sm:min-h-[450px] flex justify-center items-center transform scale-100 origin-center">
      <Canvas
        camera={{ position, fov }}
...
function Band({
  ...
  const frontTex = useTexture(frontImage || lanyardPng);
  const backTex = useTexture(backImage || lanyardPng);
