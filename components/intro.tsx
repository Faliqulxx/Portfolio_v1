...
<span className="font-bold">Data Science, Data Analysis, and AI Automation</span>,
with hands-on experience using <span className="font-bold">Laravel</span> and{" "}
<span className="font-bold">CodeIgniter</span> for developing web-based dashboards
and applications, as well as <span className="font-bold">Python</span> and{" "}
<span className="font-bold">SQL</span> for data processing, analysis, and machine
learning workflows.
